...
Design decisions and guidance for contributors working on the OpenRail Association website.
...
This project uses conventional commits: `feat(scope): description`, `fix(scope): description`, etc.
